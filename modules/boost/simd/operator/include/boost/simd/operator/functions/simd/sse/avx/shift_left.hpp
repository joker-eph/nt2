...
namespace boost { namespace simd { namespace ext
{
                            ...
                            )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL(2)
    {
      ...
      itype that = _mm256_insertf128_si256(that,boost::simd::shift_left( a00, a1), 0);
      return  simd::bitwise_cast<A0>(_mm256_insertf128_si256(that, boost::simd::shift_left(a01, a1), 1));
     }
  };
} } }
