...
NT2_TEST_CASE_TPL ( pow_real__2_2,  NT2_SIMD_REAL_TYPES)
{
  using nt2::pow;
  using nt2::tag::pow_;
  using nt2::load;
  ...
  // specific values tests
  NT2_TEST_ULP_EQUAL(pow(nt2::Inf<vT>(),3)[0], nt2::Inf<sr_t>(), 0);
  NT2_TEST_ULP_EQUAL(pow(nt2::Inf<vT>(),4)[0], nt2::Inf<sr_t>(), 0);
  NT2_TEST_ULP_EQUAL(pow(nt2::Minf<vT>(),3)[0], nt2::Minf<sr_t>(), 0);
  NT2_TEST_ULP_EQUAL(pow(nt2::Minf<vT>(),4)[0], nt2::Inf<sr_t>(), 0);
  NT2_TEST_ULP_EQUAL(pow(nt2::Mone<vT>(),3)[0], nt2::Mone<sr_t>(), 0);
  NT2_TEST_ULP_EQUAL(pow(nt2::Mone<vT>(),4)[0], nt2::One<sr_t>(), 0);
  NT2_TEST_ULP_EQUAL(pow(nt2::Nan<vT>(),3)[0], nt2::Nan<sr_t>(), 0);
  NT2_TEST_ULP_EQUAL(pow(nt2::Nan<vT>(),4)[0], nt2::Nan<sr_t>(), 0);
  NT2_TEST_ULP_EQUAL(pow(nt2::One<vT>(),3)[0], nt2::One<sr_t>(), 0);
  NT2_TEST_ULP_EQUAL(pow(nt2::One<vT>(),4)[0], nt2::One<sr_t>(), 0);
  NT2_TEST_ULP_EQUAL(pow(nt2::Zero<vT>(),3)[0], nt2::Zero<sr_t>(), 0);
  NT2_TEST_ULP_EQUAL(pow(nt2::Zero<vT>(),4)[0], nt2::Zero<sr_t>(), 0);
} // end of test for floating_
